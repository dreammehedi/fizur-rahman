...
function SkillTopicItem({ skillItem }) {
  return (
    <>
      <div className="group text-center cursor-pointer my-transition space-y-3 text-primary font-semibold rounded-xl overflow-hidden">
        <Tilt
          perspective={600}
        ...
        >
          <div className="bg-main-bg p-6 md:p-8 rounded-xl flex flex-col justify-center items-center space-y-3 my-transition grayscale hover:grayscale-0 text-center ring-1 ring-ring-color overflow-hidden">
            <img
              src={skillItem?.icon}
